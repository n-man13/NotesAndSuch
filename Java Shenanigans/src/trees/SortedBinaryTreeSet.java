...
public class SortedBinaryTreeSet<T extends Comparable<T>> implements Set<T> {
	private DoubleEndedTreeNode<T> root;

	public SortedBinaryTreeSet() {
		root = null;
	}

	public SortedBinaryTreeSet(List<T> a) throws Exception {
		// add all to the set
	...
	public boolean contains(T item) {
		return find(item) != null; // placeholder
	}
	public void balanceTree() {
		
	}
	private DoubleEndedTreeNode<T> find(T item){
		DoubleEndedTreeNode<T> curr = root;
		while (curr != null) {
